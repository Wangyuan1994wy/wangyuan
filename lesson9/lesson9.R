...
as.data.frame(table(cgss2013$a7a))#方式之一，不推荐
...
prop.table(table(cgss2013$a7a,cgss2013$a2), 1)#行百分比
prop.table(table(cgss2013$a7a,cgss2013$a2), 2)#列百分比
...
# C. 相关分析
cor(cgss2013$a8a,cgss2013$a8b,use="complete.obs",method = c("pearson")) 
#use定义数据集，method定义相关系数种类（默认为pearson）

par(family="STKaiti")

plot(cgss2013$a8a,cgss2013$a8b,ann = FALSE)
...
# 图
sjp.xtab(cgss2013$a10,cgss2013$a2,type ="bar", margin ="col",
         bar.pos = "stack")
...
cbind(observed, chisq.test(observed)$expected) #合并比较
