...
trucks <- c(2, 5, 4, 5, 12)
# 取得取值范围
g_range <- range(0, cars, trucks) #可以做出去掉某些值的图
...
##对比下图
ggplot(data = car::Prestige,mapping = aes(x = income, y = prestige)) + 
  geom_smooth()+
  geom_point()
# 分色散点图
...
# 结构连续变化图 geom_area
setwd("/Users/wangyuan/Documents/GitHub/personal/lesson7")
